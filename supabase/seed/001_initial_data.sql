...
-- Primeiro limpa dados existentes, depois insere
-- ============================================

-- ============================================
-- 0. Limpa dados de seed existentes (ordem importa: filhos antes de pais)
-- ============================================

DELETE FROM "session_settings" WHERE "id" IN ('settings-0001', 'settings-0002', 'settings-0003');
DELETE FROM "holidays" WHERE "id" LIKE 'holiday-%';
DELETE FROM "enrollments" WHERE "id" LIKE 'enroll-%';
DELETE FROM "classes" WHERE "id" LIKE 'class-%';
DELETE FROM "teacher_availabilities" WHERE "id" LIKE 'avail-%';
DELETE FROM "semesters" WHERE "id" LIKE 'semester-%';
DELETE FROM "rooms" WHERE "id" LIKE 'room-%';
DELETE FROM "subjects" WHERE "id" LIKE 'subject-%';
DELETE FROM "courses" WHERE "id" LIKE 'course-%';
DELETE FROM "students" WHERE "id" LIKE 'student-%';
DELETE FROM "teachers" WHERE "id" LIKE 'teacher-%';
DELETE FROM "coordinators" WHERE "id" LIKE 'coord-%';
DELETE FROM "profiles" WHERE "id" LIKE 'profile-%';
DELETE FROM "role_permissions" WHERE "id" LIKE 'rp-%';
...
INSERT INTO "role_permissions" ("id", "role_id", "permission_id") VALUES
  ('rp-0201', 'PROFESSOR', 'perm-0008'),
  ('rp-0202', 'PROFESSOR', 'perm-0009'),
  ('rp-0203', 'PROFESSOR', 'perm-0010'),
  ('rp-0204', 'PROFESSOR', 'perm-0016');

-- STUDENT: Acesso a materiais, mensagens e visualização
INSERT INTO "role_permissions" ("id", "role_id", "permission_id") VALUES
  ('rp-0301', 'STUDENT', 'perm-0009'),
  ('rp-0302', 'STUDENT', 'perm-0016');

-- ASSISTANT: Assistente administrativo com acesso limitado
INSERT INTO "role_permissions" ("id", "role_id", "permission_id") VALUES
  ('rp-0401', 'ASSISTANT', 'perm-0002'),
  ('rp-0402', 'ASSISTANT', 'perm-0003'),
  ('rp-0403', 'ASSISTANT', 'perm-0005'),
  ('rp-0404', 'ASSISTANT', 'perm-0006'),
  ('rp-0405', 'ASSISTANT', 'perm-0009'),
  ('rp-0406', 'ASSISTANT', 'perm-0010'),
  ('rp-0407', 'ASSISTANT', 'perm-0011'),
  ('rp-0408', 'ASSISTANT', 'perm-0015');
