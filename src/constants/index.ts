...
export const SIDEBAR_MENU_ITEMS = {
  ...
  [Role.COORDINATOR]: [
    ...
    { id: 'teachers', label: 'Professores', icon: 'GraduationCap', href: '/coordinator/teachers' },
    { id: 'students', label: 'Alunos', icon: 'BookOpen', href: '/coordinator/students' },
    { id: 'courses', label: 'Cursos', icon: 'Library', href: '/coordinator' },
    { id: 'subjects', label: 'Disciplinas', icon: 'BookMarked', href: '/coordinator/subjects' },
    { id: 'enrollments', label: 'Matrículas', icon: 'UsersRound', href: '/coordinator/enrollments' },
    { id: 'divider_schedule', label: 'Agenda', isDivider: true },
    { id: 'schedule', label: 'Grade Horária', icon: 'CalendarDays', href: '/coordinator/schedules' },
    { id: 'classes', label: 'Turmas', icon: 'UsersRound', href: '/coordinator/classes' },
    { id: 'rooms', label: 'Salas', icon: 'DoorOpen', href: '/coordinator/rooms' },
    { id: 'semesters', label: 'Semestres', icon: 'CalendarRange', href: '/coordinator' },
    { id: 'holidays', label: 'Feriados', icon: 'PartyPopper', href: '/coordinator' },
    { id: 'divider_tracking', label: 'Acompanhamento', isDivider: true },
    { id: 'attendance', label: 'Frequência', icon: 'ClipboardCheck', href: '/coordinator' },
    { id: 'assignments', label: 'Atividades', icon: 'FileText', href: '/coordinator' },
    { id: 'materials', label: 'Materiais', icon: 'FolderOpen', href: '/coordinator' },
    { id: 'divider_analytics', label: 'Análise', isDivider: true },
    { id: 'reports', label: 'Relatórios', icon: 'BarChart3', href: '/coordinator/reports' },
    { id: 'evasion', label: 'Evasão', icon: 'AlertTriangle', href: '/coordinator' },
    { id: 'audit', label: 'Auditoria', icon: 'FileSearch', href: '/coordinator' },
    ...
    { id: 'announcements', label: 'Comunicados', icon: 'Megaphone', href: '/coordinator' },
    { id: 'divider_settings', label: 'Configurações', isDivider: true },
    { id: 'settings', label: 'Configurações', icon: 'Settings', href: '/coordinator' },
  ],

  [Role.PROFESSOR]: [
    { id: 'dashboard', label: 'Painel', icon: 'LayoutDashboard', href: '/professor' },
    ...
    { id: 'divider_communication', label: 'Comunicação', isDivider: true },
    { id: 'messages', label: 'Mensagens', icon: 'MessageSquare', href: '/professor/messages', badge: 'unread' },
    { id: 'notifications', label: 'Notificações', icon: 'Bell', href: '/professor', badge: 'unread' },
  ...
  [Role.STUDENT]: [
    { id: 'dashboard', label: 'Painel', icon: 'LayoutDashboard', href: '/student' },
    { id: 'divider_academic', label: 'Acadêmico', isDivider: true },
    ...
    { id: 'divider_communication', label: 'Comunicação', isDivider: true },
    { id: 'messages', label: 'Mensagens', icon: 'MessageSquare', href: '/student/messages', badge: 'unread' },
    { id: 'notifications', label: 'Notificações', icon: 'Bell', href: '/student', badge: 'unread' },
  ],
